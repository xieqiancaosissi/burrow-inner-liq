...
export default function NormalMemeLiquidation() {
  ...
  function handleDetailsClick(accountId: string, position: string) {
    router.push(
      `/details?accountId=${accountId}&position=${position}&contract_id=meme-burrow.ref-labs.near&priceOracleId=meme-priceoracle.ref-labs.near`
    );
  }
  ...
  return (
    ...
    >
      <div
        ...
        style={{ height: "60px" }}
      >
        Pending Meme Liquidation (Total: {liquidations.length})
        <p className="ml-2">
